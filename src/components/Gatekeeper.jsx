    ...
    if (error) {
        return (
            <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: 'sans-serif', color: '#dc2626', backgroundColor: '#fef2f2' }}>
                ...
                <p>Por favor, inicie sesión a través del <a href="https://direccion-tecnica-ia-lab.vercel.app" style={{ color: '#0284c7', fontWeight: 'bold' }}>Portal Oficial Dirección Técnica</a>.</p>
            </div>
        );
    }
